# TrustLLM — [ICML 2024] TrustLLM: Trustworthiness in Large Langu… | olud.ai

> Evaluate the trustworthiness of large language models using the TrustLLM toolkit for comprehensive assessments and dynamic (MIT, 2023). 630 stars on GitHub.

_Source: https://olud.ai/project/howiehwong-trustllm.html_
...
by **HowieHwong** · GitHub

[630](https://olud.ai/most-starred.html)
...
[View on GitHub](https://github.com/HowieHwong/TrustLLM)

𝕏  X / Twitter

🔗  Copy link

In plain wordsEvaluate the trustworthiness of large language models using the TrustLLM toolkit for comprehensive assessments and dynamic evaluations.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=HowieHwong%2FTrustLLM)
...
TrustLLM has 630 stars on GitHub. It has been forked 67 times. TrustLLM is written mainly in Python. It has been in active development since 2023. TrustLLM is available under the MIT license. Its main topics are ai, benchmark, dataset, evaluation.
...
#### Is TrustLLM open source?
TrustLLM is an open-source project. It is released under the MIT license.

#### Is TrustLLM free?
Yes. TrustLLM is free and open source — you can use, modify and self-host it.

#### What license does TrustLLM use?
TrustLLM is available under the MIT license.

#### What language is TrustLLM written in?
TrustLLM is written mainly in Python.

🏅 Maintainer of this project?

olud.ai badge — TrustLLM
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=howiehwong-trustllm)](https://olud.ai/project/howiehwong-trustllm.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/trustworthy-ai.html)
