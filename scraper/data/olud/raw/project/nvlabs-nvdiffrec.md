# nvdiffrec — Official code for the CVPR 2022 (oral) paper "Extrac… | olud.ai

> Extract 3D models, materials, and lighting from images using advanced optimization techniques (—, 2021). 2.3k stars on GitHub.

_Source: https://olud.ai/project/nvlabs-nvdiffrec.html_
...
[248](https://olud.ai/most-forked.html)
...
[View on GitHub](https://github.com/NVlabs/nvdiffrec)

𝕏  X / Twitter

🔗  Copy link

In plain wordsExtract 3D models, materials, and lighting from images using advanced optimization techniques.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=NVlabs%2Fnvdiffrec)
...
nvdiffrec has 2.3k stars on GitHub. It has been forked 248 times. nvdiffrec is written mainly in Python. It has been in active development since 2021. Its main topics are deep-learning, pytorch.
...
nvdiffrec is an open-source project.

#### Is nvdiffrec free?
Yes. nvdiffrec is free and open source — you can use, modify and self-host it.

#### What language is nvdiffrec written in?
nvdiffrec is written mainly in Python.

🏅 Maintainer of this project?

olud.ai badge — nvdiffrec
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=nvlabs-nvdiffrec)](https://olud.ai/project/nvlabs-nvdiffrec.html)`
Copy Markdown
...
- [trlx A repo for distributed training of language models with Reinforcement Learning via Human Feedba… ★ 4.8k · machine-learning sharespytorch](https://olud.ai/project/carperai-trlx.html)
