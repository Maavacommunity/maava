# perplexity-ai — Unofficial API Wrapper for Perplexity.ai + Account G… | olud.ai

> Create and manage multiple accounts for unlimited queries using a web interface. Unofficial API Wrapper for Perplexity.ai (MIT, 2023). 1.8k stars on GitHub.

_Source: https://olud.ai/project/helallao-perplexity-ai.html_
...
[317](https://olud.ai/most-forked.html)
...
[View on GitHub](https://github.com/helallao/perplexity-ai)

𝕏  X / Twitter

🔗  Copy link

In plain wordsCreate and manage multiple accounts for unlimited queries using a web interface.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=helallao%2Fperplexity-ai)
...
perplexity-ai has 1.8k stars on GitHub. It has been forked 317 times. perplexity-ai is written mainly in Python. It has been in active development since 2023. perplexity-ai is available under the MIT license. Its main topics are ai, api, artificial-intelligence, chatgpt.
...
#### Is perplexity-ai open source?
perplexity-ai is an open-source project. It is released under the MIT license.

#### Is perplexity-ai free?
Yes. perplexity-ai is free and open source — you can use, modify and self-host it.

#### What license does perplexity-ai use?
perplexity-ai is available under the MIT license.

#### What language is perplexity-ai written in?
perplexity-ai is written mainly in Python.

🏅 Maintainer of this project?

olud.ai badge — perplexity-ai
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=helallao-perplexity-ai)](https://olud.ai/project/helallao-perplexity-ai.html)`
Copy Markdown
