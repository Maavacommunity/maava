# rushdb — RushDB is a graph + vector database and memory layer… | olud.ai

> Store and search data in a flexible database that understands relationships and can handle JSON without complex setup (—, 2024). 320 stars on GitHub.

_Source: https://olud.ai/project/rush-db-rushdb.html_
...
- [ai-memory](https://olud.ai/dna/ai-memory.html)
- [TypeScript](https://olud.ai/language/typescript.html)
Self-hostable

[View on GitHub](https://github.com/rush-db/rushdb)

𝕏  X / Twitter

🔗  Copy link

In plain wordsStore and search data in a flexible database that understands relationships and can handle JSON without complex setup.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=rush-db%2Frushdb)
...
rushdb has 320 stars on GitHub. It has been forked 25 times. rushdb is written mainly in TypeScript. It has been in active development since 2024. Its main topics are ai, ai-agents, ai-memory, ai-tools.
...
#### Is rushdb open source?
rushdb is an open-source project.

#### Is rushdb free?
Yes. rushdb is free and open source — you can use, modify and self-host it.

#### What language is rushdb written in?
rushdb is written mainly in TypeScript.

🏅 Maintainer of this project?

olud.ai badge — rushdb
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=rush-db-rushdb)](https://olud.ai/project/rush-db-rushdb.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/ai-memory.html)
