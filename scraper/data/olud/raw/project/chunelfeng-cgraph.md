# CGraph — 【A common used C++ & Python DAG framework】 一个通用的、无三方… | olud.ai

> 【A common used C++ & Python DAG framework】 一个通用的、无三方依赖的、跨平台的、收录于awesome-cpp的、基于流图的并行计算框架。欢迎star & fork & 交流 (MIT, 2021). 2.3k stars on GitHub.

_Source: https://olud.ai/project/chunelfeng-cgraph.html_
...
by **ChunelFeng** · GitHub

[2.3k](https://olud.ai/most-starred.html)

Stars

[389](https://olud.ai/most-forked.html)
...
- [dag](https://olud.ai/dna/dag.html)
MIT
- [C++](https://olud.ai/language/cpp.html)

[View on GitHub](https://github.com/ChunelFeng/CGraph)
...
[Claim this page →](https://olud.ai/claim.html?repo=ChunelFeng%2FCGraph)
...
CGraph has 2.3k stars on GitHub. It has been forked 389 times. CGraph is written mainly in C++. It has been in active development since 2021. CGraph is available under the MIT license. Its main topics are ai, ai-agents, dag, graph.
...
#### Is CGraph open source?
CGraph is an open-source project. It is released under the MIT license.

#### Is CGraph free?
Yes. CGraph is free and open source — you can use, modify and self-host it.

#### What license does CGraph use?
CGraph is available under the MIT license.

#### What language is CGraph written in?
CGraph is written mainly in C++.

🏅 Maintainer of this project?

olud.ai badge — CGraph
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=chunelfeng-cgraph)](https://olud.ai/project/chunelfeng-cgraph.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Shares DNA with[🧬 View the DNA map →](https://olud.ai/dna/dag.html)
- [rs-graph-llm High-performance framework for building interactive workflow systems in Rust. Designed for comp… ★ 350 · agents sharesgraphlanggraph](https://olud.ai/project/a-agmon-rs-graph-llm.html)
