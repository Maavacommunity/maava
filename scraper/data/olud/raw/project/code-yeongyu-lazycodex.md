# lazycodex — The one and only agent harness for complex codebases… | olud.ai

> Manage complex coding projects with planning and execution tools inside Codex. The one and only agent harness for complex (MIT, 2026). 3.4k stars on GitHub.

_Source: https://olud.ai/project/code-yeongyu-lazycodex.html_
...
[+112 this week](https://olud.ai/trending.html)
...
[View on GitHub](https://github.com/code-yeongyu/lazycodex)

𝕏  X / Twitter

🔗  Copy link

In plain wordsManage complex coding projects with planning and execution tools inside Codex.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=code-yeongyu%2Flazycodex)
...
lazycodex has 3.4k stars on GitHub. It has been forked 210 times. lazycodex is written mainly in TypeScript. It has been in active development since 2026. lazycodex is available under the MIT license. Its main topics are ai, ai-agents, claude, claude-code.
...
#### Is lazycodex open source?
lazycodex is an open-source project. It is released under the MIT license.

#### Is lazycodex free?
Yes. lazycodex is free and open source — you can use, modify and self-host it.

#### What license does lazycodex use?
lazycodex is available under the MIT license.

#### What language is lazycodex written in?
lazycodex is written mainly in TypeScript.

🏅 Maintainer of this project?

olud.ai badge — lazycodex
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=code-yeongyu-lazycodex)](https://olud.ai/project/code-yeongyu-lazycodex.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/orchestration.html)
