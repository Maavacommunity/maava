# bark — Open-Source Framework for Development, Simulation an… | olud.ai

> Develop and test decision-making algorithms for self-driving cars using a simulation framework (MIT, 2019). 306 stars on GitHub.

_Source: https://olud.ai/project/bark-simulator-bark.html_
...
[View on GitHub](https://github.com/bark-simulator/bark)

𝕏  X / Twitter

🔗  Copy link

In plain wordsDevelop and test decision-making algorithms for self-driving cars using a simulation framework.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=bark-simulator%2Fbark)
...
bark has 306 stars on GitHub. It has been forked 72 times. bark is written mainly in C++. It has been in active development since 2019. bark is available under the MIT license. Its main topics are artificial-intelligence, autonomous-driving, autonomous-vehicles, bark.
...
#### Is bark open source?
bark is an open-source project. It is released under the MIT license.

#### Is bark free?
Yes. bark is free and open source — you can use, modify and self-host it.

#### What license does bark use?
bark is available under the MIT license.

#### What language is bark written in?
bark is written mainly in C++.
...
`[![olud.ai](https://olud.ai/badge.php?tool=bark-simulator-bark)](https://olud.ai/project/bark-simulator-bark.html)`
Copy Markdown
