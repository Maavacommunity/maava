# taskade — The AI-native workspace platform. Projects remember.… | olud.ai

> Manage projects and automate tasks using an AI-powered workspace that remembers your work. The AI-native workspace platform (—, 2026). 62 stars on GitHub.

_Source: https://olud.ai/project/taskade-taskade.html_
...
[62](https://olud.ai/most-starred.html)
...
- [ai-app-builder](https://olud.ai/dna/ai-app-builder.html)

[View on GitHub](https://github.com/taskade/taskade)

𝕏  X / Twitter

🔗  Copy link

In plain wordsManage projects and automate tasks using an AI-powered workspace that remembers your work.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=taskade%2Ftaskade)
...
taskade has 62 stars on GitHub. It has been forked 16 times. It has been in active development since 2026. Its main topics are ai, ai-agents, ai-app-builder, automation.
...
taskade is an open-source project.

#### Is taskade free?
Yes. taskade is free and open source — you can use, modify and self-host it.

🏅 Maintainer of this project?

olud.ai badge — taskade
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=taskade-taskade)](https://olud.ai/project/taskade-taskade.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/ai-app-builder.html)
