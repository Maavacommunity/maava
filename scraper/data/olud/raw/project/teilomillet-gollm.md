# gollm — Unified Go interface for Language Model (LLM) provid… | olud.ai

> Create your own AI applications by connecting to various language models easily. Unified Go interface for Language (Apache-2.0, 2024). 674 stars on GitHub.

_Source: https://olud.ai/project/teilomillet-gollm.html_
...
- [dspy](https://olud.ai/dna/dspy.html)
Apache-2.0
- [Go](https://olud.ai/language/go.html)

[View on GitHub](https://github.com/teilomillet/gollm)

𝕏  X / Twitter

🔗  Copy link

In plain wordsCreate your own AI applications by connecting to various language models easily.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=teilomillet%2Fgollm)
...
gollm has 674 stars on GitHub. It has been forked 67 times. gollm is written mainly in Go. It has been in active development since 2024. gollm is available under the Apache-2.0 license. Its main topics are ai, anthropic, dspy, genai.
...
gollm is an open-source project. It is released under the Apache-2.0 license.

#### Is gollm free?
Yes. gollm is free and open source — you can use, modify and self-host it.

#### What license does gollm use?
gollm is available under the Apache-2.0 license.

#### What language is gollm written in?
gollm is written mainly in Go.
...
`[![olud.ai](https://olud.ai/badge.php?tool=teilomillet-gollm)](https://olud.ai/project/teilomillet-gollm.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/dspy.html)
