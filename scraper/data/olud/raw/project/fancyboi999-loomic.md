# Loomic — Open-source AI canvas design agent — alternative to… | olud.ai

> Design images and videos by chatting with an AI on an endless canvas, without needing templates or timelines (—, 2026). 196 stars on GitHub.

_Source: https://olud.ai/project/fancyboi999-loomic.html_
...
[196](https://olud.ai/most-starred.html)
...
- [canva-alternative](https://olud.ai/projects.html?cat=canva-alternative)
- [TypeScript](https://olud.ai/language/typescript.html)

[View on GitHub](https://github.com/fancyboi999/Loomic)

𝕏  X / Twitter

🔗  Copy link

In plain wordsDesign images and videos by chatting with an AI on an endless canvas, without needing templates or timelines.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=fancyboi999%2FLoomic)
...
Loomic has 196 stars on GitHub. It has been forked 44 times. Loomic is written mainly in TypeScript. It has been in active development since 2026. Its main topics are ai, ai-agent, canva-alternative, canvas.
...
#### Is Loomic open source?
Loomic is an open-source project.

#### Is Loomic free?
Yes. Loomic is free and open source — you can use, modify and self-host it.

#### What language is Loomic written in?
Loomic is written mainly in TypeScript.

🏅 Maintainer of this project?

olud.ai badge — Loomic
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=fancyboi999-loomic)](https://olud.ai/project/fancyboi999-loomic.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/canvas.html)
