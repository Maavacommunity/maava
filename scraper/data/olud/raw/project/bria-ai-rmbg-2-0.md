# RMBG-2.0 — Bria RMBG 2.0 - image background removee | olud.ai

> Remove backgrounds from images effectively for commercial use, suitable for various content types like e-commerce and (—, 2025). 308 stars on GitHub.

_Source: https://olud.ai/project/bria-ai-rmbg-2-0.html_
...
[308](https://olud.ai/most-starred.html)
...
Language
- [ai](https://olud.ai/projects.html?cat=ai)
- [background-removal](https://olud.ai/dna/background-removal.html)
- [birefnet](https://olud.ai/projects.html?cat=birefnet)
- [Python](https://olud.ai/language/python.html)

[View on GitHub](https://github.com/Bria-AI/RMBG-2.0)

𝕏  X / Twitter

🔗  Copy link

In plain wordsRemove backgrounds from images effectively for commercial use, suitable for various content types like e-commerce and advertising.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=Bria-AI%2FRMBG-2.0)
...
RMBG-2.0 has 308 stars on GitHub. It has been forked 27 times. RMBG-2.0 is written mainly in Python. It has been in active development since 2025. Its main topics are ai, background-removal, birefnet, briaai.
...
#### Is RMBG-2.0 open source?
RMBG-2.0 is an open-source project.

#### Is RMBG-2.0 free?
Yes. RMBG-2.0 is free and open source — you can use, modify and self-host it.

#### What language is RMBG-2.0 written in?
RMBG-2.0 is written mainly in Python.

🏅 Maintainer of this project?

olud.ai badge — RMBG-2.0
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=bria-ai-rmbg-2-0)](https://olud.ai/project/bria-ai-rmbg-2-0.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/background-removal.html)
