# fojin — Buddhist Digital Text Platform — 10,500+ texts, 613… | olud.ai

> Ask questions about Buddhist texts and receive answers linked to the original sources in multiple languages (Apache-2.0, 2026). 336 stars on GitHub.

_Source: https://olud.ai/project/xr843-fojin.html_
...
[61](https://olud.ai/most-forked.html)
...
Self-hostable
- [ai](https://olud.ai/projects.html?cat=ai)
- [buddhism](https://olud.ai/projects.html?cat=buddhism)
- [buddhist-studies](https://olud.ai/projects.html?cat=buddhist-studies)
Apache-2.0
- [Python](https://olud.ai/language/python.html)
Self-hostable

[View on GitHub](https://github.com/xr843/fojin)

𝕏  X / Twitter

🔗  Copy link

In plain wordsAsk questions about Buddhist texts and receive answers linked to the original sources in multiple languages.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=xr843%2Ffojin)
...
fojin has 336 stars on GitHub. It has been forked 61 times. fojin is written mainly in Python. It has been in active development since 2026. fojin is available under the Apache-2.0 license. Its main topics are ai, buddhism, buddhist-studies, chinese-classics.
...
#### Is fojin open source?
fojin is an open-source project. It is released under the Apache-2.0 license.

#### Is fojin free?
Yes. fojin is free and open source — you can use, modify and self-host it.

#### What license does fojin use?
fojin is available under the Apache-2.0 license.

#### What language is fojin written in?
fojin is written mainly in Python.
...
`[![olud.ai](https://olud.ai/badge.php?tool=xr843-fojin)](https://olud.ai/project/xr843-fojin.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/elasticsearch.html)
