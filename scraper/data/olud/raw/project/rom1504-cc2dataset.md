# cc2dataset — Easily convert common crawl to a dataset of caption… | olud.ai

> Convert web data into a structured dataset with captions and documents for various media types (MIT, 2022). 321 stars on GitHub.

_Source: https://olud.ai/project/rom1504-cc2dataset.html_
...
[321](https://olud.ai/most-starred.html)
...
- [multimodal](https://olud.ai/projects.html?cat=multimodal)
MIT
- [Python](https://olud.ai/language/python.html)

[View on GitHub](https://github.com/rom1504/cc2dataset)

𝕏  X / Twitter

🔗  Copy link

In plain wordsConvert web data into a structured dataset with captions and documents for various media types.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=rom1504%2Fcc2dataset)
...
cc2dataset has 321 stars on GitHub. It has been forked 26 times. cc2dataset is written mainly in Python. It has been in active development since 2022. cc2dataset is available under the MIT license. Its main topics are big-data, dataset, multimodal.
...
#### Is cc2dataset open source?
cc2dataset is an open-source project. It is released under the MIT license.

#### Is cc2dataset free?
Yes. cc2dataset is free and open source — you can use, modify and self-host it.

#### What license does cc2dataset use?
cc2dataset is available under the MIT license.

#### What language is cc2dataset written in?
cc2dataset is written mainly in Python.
...
- [img2dataset Easily turn large sets of image urls to an image dataset. Can download, resize and package 100M… ★ 4.4k · big-data sharesbig-data](https://olud.ai/project/rom1504-img2dataset.html)
