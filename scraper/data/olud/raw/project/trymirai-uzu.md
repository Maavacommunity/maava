# uzu — A high-performance inference engine for AI models | olud.ai

> Integrate AI models into your applications with a fast inference engine that ensures privacy and low latency (MIT, 2025). 1.7k stars on GitHub.

_Source: https://olud.ai/project/trymirai-uzu.html_
...
Language
- [ai](https://olud.ai/projects.html?cat=ai)
- [high-performance](https://olud.ai/dna/high-performance.html)
- [inference](https://olud.ai/dna/inference.html)
MIT
- [Rust](https://olud.ai/language/rust.html)

[View on GitHub](https://github.com/trymirai/uzu)

𝕏  X / Twitter

🔗  Copy link

In plain wordsIntegrate AI models into your applications with a fast inference engine that ensures privacy and low latency.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=trymirai%2Fuzu)
...
uzu has 1.7k stars on GitHub. It has been forked 73 times. uzu is written mainly in Rust. It has been in active development since 2025. uzu is available under the MIT license. Its main topics are ai, high-performance, inference, llm.
...
#### Is uzu open source?
uzu is an open-source project. It is released under the MIT license.

#### Is uzu free?
Yes. uzu is free and open source — you can use, modify and self-host it.

#### What license does uzu use?
uzu is available under the MIT license.

#### What language is uzu written in?
uzu is written mainly in Rust.
...
`[![olud.ai](https://olud.ai/badge.php?tool=trymirai-uzu)](https://olud.ai/project/trymirai-uzu.html)`
Copy Markdown
