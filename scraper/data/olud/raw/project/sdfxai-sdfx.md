# sdfx — The ultimate no-code platform to build and share AI… | olud.ai

> Create and share AI applications with user-friendly designs without needing to write code (AGPL-3.0, 2024). 447 stars on GitHub.

_Source: https://olud.ai/project/sdfxai-sdfx.html_
...
[447](https://olud.ai/most-starred.html)
...
- [sdfx](https://olud.ai/projects.html?cat=sdfx)
AGPL-3.0
- [TypeScript](https://olud.ai/language/typescript.html)

[View on GitHub](https://github.com/sdfxai/sdfx)

𝕏  X / Twitter

🔗  Copy link

In plain wordsCreate and share AI applications with user-friendly designs without needing to write code.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=sdfxai%2Fsdfx)
...
sdfx has 447 stars on GitHub. It has been forked 32 times. sdfx is written mainly in TypeScript. It has been in active development since 2024. sdfx is available under the AGPL-3.0 license. Its main topics are ai, generative-ai, sdfx.
...
#### Is sdfx open source?
sdfx is an open-source project. It is released under the AGPL-3.0 license.

#### Is sdfx free?
Yes. sdfx is free and open source — you can use, modify and self-host it. Its AGPL-3.0 license is a strong copyleft: if you distribute a modified version — including offering it as a network service — your changes must be released under the same license.

#### What license does sdfx use?
sdfx is available under the AGPL-3.0 license.

#### What language is sdfx written in?
sdfx is written mainly in TypeScript.
...
`[![olud.ai](https://olud.ai/badge.php?tool=sdfxai-sdfx)](https://olud.ai/project/sdfxai-sdfx.html)`
Copy Markdown
