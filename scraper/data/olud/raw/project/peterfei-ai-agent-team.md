# ai-agent-team — AI Agent Team-拥有24/7专业AI开发团队：产品经理、前端开发、后端开发、测试工程师、De… | olud.ai

> Install a team of AI developers to enhance your project with various technical skills (MIT, 2025). 428 stars on GitHub.

_Source: https://olud.ai/project/peterfei-ai-agent-team.html_
...
[428](https://olud.ai/most-starred.html)
...
[24886](https://olud.ai/projects.html?cat=24886)
...
[View on GitHub](https://github.com/peterfei/ai-agent-team)

𝕏  X / Twitter

🔗  Copy link

In plain wordsInstall a team of AI developers to enhance your project with various technical skills.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=peterfei%2Fai-agent-team)
...
ai-agent-team has 428 stars on GitHub. It has been forked 65 times. ai-agent-team is written mainly in JavaScript. It has been in active development since 2025. ai-agent-team is available under the MIT license. Its main topics are 24886, ai, ai-agents, claude-code.
...
#### Is ai-agent-team open source?
ai-agent-team is an open-source project. It is released under the MIT license.

#### Is ai-agent-team free?
Yes. ai-agent-team is free and open source — you can use, modify and self-host it.

#### What license does ai-agent-team use?
ai-agent-team is available under the MIT license.

#### What language is ai-agent-team written in?
ai-agent-team is written mainly in JavaScript.

🏅 Maintainer of this project?

olud.ai badge — ai-agent-team
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=peterfei-ai-agent-team)](https://olud.ai/project/peterfei-ai-agent-team.html)`
Copy Markdown
