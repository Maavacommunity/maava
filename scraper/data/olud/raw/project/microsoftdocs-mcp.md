# mcp — Official Microsoft Learn MCP Server and CLI tool – p… | olud.ai

> Official Microsoft Learn MCP Server and CLI tool – powering LLMs and AI agents with real-time, trusted Microsoft docs & code samples. (CC-BY-4.0, 2025). 1.9k st…

_Source: https://olud.ai/project/microsoftdocs-mcp.html_
...
[238](https://olud.ai/most-forked.html)

Forks

[+26 this week](https://olud.ai/trending.html)
...
[View on GitHub](https://github.com/MicrosoftDocs/mcp)
...
[Claim this page →](https://olud.ai/claim.html?repo=MicrosoftDocs%2Fmcp)
...
mcp has 1.9k stars on GitHub. It has been forked 238 times. mcp is written mainly in TypeScript. It has been in active development since 2025. mcp is available under the CC-BY-4.0 license. Its main topics are ai, ai-agents, cli, copilot.
...
#### Is mcp open source?
mcp is an open-source project. It is released under the CC-BY-4.0 license.

#### Is mcp free?
Yes. mcp is free and open source — you can use, modify and self-host it.

#### What license does mcp use?
mcp is available under the CC-BY-4.0 license.

#### What language is mcp written in?
mcp is written mainly in TypeScript.
...
`[![olud.ai](https://olud.ai/badge.php?tool=microsoftdocs-mcp)](https://olud.ai/project/microsoftdocs-mcp.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/copilot.html)
