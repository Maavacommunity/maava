# kalosm — Instant, controllable, local pre-trained AI models i… | olud.ai

> Use pre-trained AI models easily in your applications with a simple interface in Rust (Apache-2.0, 2023). 2.2k stars on GitHub.

_Source: https://olud.ai/project/floneum-kalosm.html_
...
Self-hostable
- [ai](https://olud.ai/projects.html?cat=ai)
- [candle](https://olud.ai/projects.html?cat=candle)
- [constrained-generation](https://olud.ai/projects.html?cat=constrained-generation)
Apache-2.0
- [Rust](https://olud.ai/language/rust.html)
Self-hostable

[View on GitHub](https://github.com/floneum/kalosm)

𝕏  X / Twitter

🔗  Copy link

In plain wordsUse pre-trained AI models easily in your applications with a simple interface in Rust.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=floneum%2Fkalosm)
...
kalosm has 2.2k stars on GitHub. It has been forked 133 times. kalosm is written mainly in Rust. It has been in active development since 2023. kalosm is available under the Apache-2.0 license. Its main topics are ai, candle, constrained-generation, dioxus.
...
kalosm is an open-source project. It is released under the Apache-2.0 license.

#### Is kalosm free?
Yes. kalosm is free and open source — you can use, modify and self-host it.

#### What license does kalosm use?
kalosm is available under the Apache-2.0 license.

#### What language is kalosm written in?
kalosm is written mainly in Rust.

🏅 Maintainer of this project?

olud.ai badge — kalosm
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=floneum-kalosm)](https://olud.ai/project/floneum-kalosm.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/llamacpp.html)
