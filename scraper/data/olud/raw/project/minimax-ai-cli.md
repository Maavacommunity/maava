# cli — Generate text, images, video, speech, and music by M… | olud.ai

> Create text, images, videos, speech, and music using AI from your terminal. Generate text, images, video, speech, and music (—, 2026). 2k stars on GitHub.

_Source: https://olud.ai/project/minimax-ai-cli.html_
...
[View on GitHub](https://github.com/MiniMax-AI/cli)

𝕏  X / Twitter

🔗  Copy link

In plain wordsCreate text, images, videos, speech, and music using AI from your terminal.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=MiniMax-AI%2Fcli)
...
cli has 2k stars on GitHub. It has been forked 144 times. cli is written mainly in TypeScript. It has been in active development since 2026. Its main topics are ai.
...
#### Is cli open source?
cli is an open-source project.

#### Is cli free?
Yes. cli is free and open source — you can use, modify and self-host it.

#### What language is cli written in?
cli is written mainly in TypeScript.
...
`[![olud.ai](https://olud.ai/badge.php?tool=minimax-ai-cli)](https://olud.ai/project/minimax-ai-cli.html)`
Copy Markdown
