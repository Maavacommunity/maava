# brain0 — The black box for AI-written code. Passive decision… | olud.ai

> Track changes in AI-generated code by linking each change to the prompts that created it (Apache-2.0, 2026). 367 stars on GitHub.

_Source: https://olud.ai/project/brain0-ai-brain0.html_
...
The black box for AI-written code. Passive decision graph linking every commit to the agent prompts behind it: drift detection, DLP audit of what agents read, evidence-driven risk, MCP memory for coding agents, signed provenance attestations. One command, offl
...
[15](https://olud.ai/most-forked.html)
...
- [attestation](https://olud.ai/projects.html?cat=attestation)
Apache-2.0
- [Rust](https://olud.ai/language/rust.html)
Self-hostable

[View on GitHub](https://github.com/Brain0-ai/brain0)

𝕏  X / Twitter

🔗  Copy link

In plain wordsTrack changes in AI-generated code by linking each change to the prompts that created it.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=Brain0-ai%2Fbrain0)
...
brain0 has 367 stars on GitHub. It has been forked 15 times. brain0 is written mainly in Rust. It has been in active development since 2026. brain0 is available under the Apache-2.0 license. Its main topics are ai, ai-agents, attestation, audit.
...
#### Is brain0 open source?
brain0 is an open-source project. It is released under the Apache-2.0 license.

#### Is brain0 free?
Yes. brain0 is free and open source — you can use, modify and self-host it.

#### What license does brain0 use?
brain0 is available under the Apache-2.0 license.

#### What language is brain0 written in?
brain0 is written mainly in Rust.

🏅 Maintainer of this project?

olud.ai badge — brain0
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=brain0-ai-brain0)](https://olud.ai/project/brain0-ai-brain0.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/audit.html)
