# Context-Engine — Context-Engine MCP - Agentic Context Compression Sui… | olud.ai

> Enhance coding assistants with memory and semantic search capabilities. Context-Engine MCP - Agentic Context Compression (MIT, 2025). 400 stars on GitHub.

_Source: https://olud.ai/project/context-engine-ai-context-engine.html_
...
[View on GitHub](https://github.com/Context-Engine-AI/Context-Engine)

𝕏  X / Twitter

🔗  Copy link

In plain wordsEnhance coding assistants with memory and semantic search capabilities.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=Context-Engine-AI%2FContext-Engine)

📈 Star history

2026-07-202026-08-31

📈 Track Context-Engine
...
Context-Engine has 400 stars on GitHub. It has been forked 54 times. Context-Engine is written mainly in Python. It has been in active development since 2025. Context-Engine is available under the MIT license. Its main topics are ai, ai-agents, codex, compression.
...
#### Is Context-Engine open source?
Context-Engine is an open-source project. It is released under the MIT license.

#### Is Context-Engine free?
Yes. Context-Engine is free and open source — you can use, modify and self-host it.

#### What license does Context-Engine use?
Context-Engine is available under the MIT license.

#### What language is Context-Engine written in?
Context-Engine is written mainly in Python.

🏅 Maintainer of this project?

olud.ai badge — Context-Engine
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=context-engine-ai-context-engine)](https://olud.ai/project/context-engine-ai-context-engine.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/compression.html)
