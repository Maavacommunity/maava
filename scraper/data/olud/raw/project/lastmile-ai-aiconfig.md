# aiconfig — AIConfig is a config-based framework to build genera… | olud.ai

> AIConfig is a config-based framework to build generative AI applications. (MIT, 2023). 1.1k stars on GitHub.

_Source: https://olud.ai/project/lastmile-ai-aiconfig.html_
...
Language
- [ai](https://olud.ai/projects.html?cat=ai)
- [developer-tools](https://olud.ai/projects.html?cat=developer-tools)
- [generative-ai](https://olud.ai/projects.html?cat=generative-ai)
MIT
- [Python](https://olud.ai/language/python.html)

[View on GitHub](https://github.com/lastmile-ai/aiconfig)
...
[Claim this page →](https://olud.ai/claim.html?repo=lastmile-ai%2Faiconfig)
...
aiconfig has 1.1k stars on GitHub. It has been forked 91 times. aiconfig is written mainly in Python. It has been in active development since 2023. aiconfig is available under the MIT license. Its main topics are ai, developer-tools, generative-ai, llm.
...
#### Is aiconfig open source?
aiconfig is an open-source project. It is released under the MIT license.

#### Is aiconfig free?
Yes. aiconfig is free and open source — you can use, modify and self-host it.

#### What license does aiconfig use?
aiconfig is available under the MIT license.

#### What language is aiconfig written in?
aiconfig is written mainly in Python.

🏅 Maintainer of this project?

olud.ai badge — aiconfig
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=lastmile-ai-aiconfig)](https://olud.ai/project/lastmile-ai-aiconfig.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/llm-ops.html)
