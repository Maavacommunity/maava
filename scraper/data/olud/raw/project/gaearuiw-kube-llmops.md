# kube-llmops — Open-Source AI Project | olud.ai

> Deploy and manage your entire AI model infrastructure on Kubernetes with a single command (Apache-2.0, 2026). 101 stars on GitHub.

_Source: https://olud.ai/project/gaearuiw-kube-llmops.html_
...
[101](https://olud.ai/most-starred.html)
...
- [fine-tuning](https://olud.ai/projects.html?cat=fine-tuning)
Apache-2.0
- [Go](https://olud.ai/language/go.html)
Self-hostable

[View on GitHub](https://github.com/GaeaRuiW/kube-llmops)

𝕏  X / Twitter

🔗  Copy link

In plain wordsDeploy and manage your entire AI model infrastructure on Kubernetes with a single command.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=GaeaRuiW%2Fkube-llmops)
...
kube-llmops has 101 stars on GitHub. It has been forked 1 times. kube-llmops is written mainly in Go. It has been in active development since 2026. kube-llmops is available under the Apache-2.0 license. Its main topics are ai, deep-learning, fine-tuning, grafana.

📦 Latest release

❓ Frequently asked questions

#### Is kube-llmops open source?
kube-llmops is an open-source project. It is released under the Apache-2.0 license.

#### Is kube-llmops free?
Yes. kube-llmops is free and open source — you can use, modify and self-host it.

#### What license does kube-llmops use?
kube-llmops is available under the Apache-2.0 license.

#### What language is kube-llmops written in?
kube-llmops is written mainly in Go.

🏅 Maintainer of this project?

olud.ai badge — kube-llmops
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=gaearuiw-kube-llmops)](https://olud.ai/project/gaearuiw-kube-llmops.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/grafana.html)
