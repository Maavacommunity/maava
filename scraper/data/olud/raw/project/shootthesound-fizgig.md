# Fizgig — Krea 2, MiniMax & Klein 9B LoRA - LoKR Studio — trai… | olud.ai

> Train and modify AI models quickly, fixing issues without starting over and saving your progress automatically (Apache-2.0, 2026). 296 stars on GitHub.

_Source: https://olud.ai/project/shootthesound-fizgig.html_
...
by **shootthesound** · GitHub

[296](https://olud.ai/most-starred.html)
...
[+121 this week](https://olud.ai/trending.html)
...
[View on GitHub](https://github.com/shootthesound/Fizgig)

𝕏  X / Twitter

🔗  Copy link

In plain wordsTrain and modify AI models quickly, fixing issues without starting over and saving your progress automatically.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=shootthesound%2FFizgig)
...
Fizgig has 296 stars on GitHub. It has been forked 31 times. Fizgig is written mainly in Python. It has been in active development since 2026. Fizgig is available under the Apache-2.0 license. Its main topics are ai, deep-learning, fine-tuning, finetuning.
...
Fizgig is an open-source project. It is released under the Apache-2.0 license.

#### Is Fizgig free?
Yes. Fizgig is free and open source — you can use, modify and self-host it.

#### What license does Fizgig use?
Fizgig is available under the Apache-2.0 license.

#### What language is Fizgig written in?
Fizgig is written mainly in Python.

🏅 Maintainer of this project?

olud.ai badge — Fizgig
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=shootthesound-fizgig)](https://olud.ai/project/shootthesound-fizgig.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/flux.html)
