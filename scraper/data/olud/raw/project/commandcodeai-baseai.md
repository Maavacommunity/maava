# BaseAI — BaseAI — The Web AI Framework. The easiest way to bu… | olud.ai

> Develop serverless AI agents with memory and tools using this framework on your local machine (—, 2024). 1.3k stars on GitHub.

_Source: https://olud.ai/project/commandcodeai-baseai.html_
...
[View on GitHub](https://github.com/CommandCodeAI/BaseAI)

𝕏  X / Twitter

🔗  Copy link

In plain wordsDevelop serverless AI agents with memory and tools using this framework on your local machine.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=CommandCodeAI%2FBaseAI)
...
BaseAI has 1.3k stars on GitHub. It has been forked 108 times. BaseAI is written mainly in TypeScript. It has been in active development since 2024. Its main topics are ai, anthropic, artificial-intelligence, baseai.
...
#### Is BaseAI open source?
BaseAI is an open-source project.

#### Is BaseAI free?
Yes. BaseAI is free and open source — you can use, modify and self-host it.

#### What language is BaseAI written in?
BaseAI is written mainly in TypeScript.

🏅 Maintainer of this project?

olud.ai badge — BaseAI
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=commandcodeai-baseai)](https://olud.ai/project/commandcodeai-baseai.html)`
Copy Markdown
