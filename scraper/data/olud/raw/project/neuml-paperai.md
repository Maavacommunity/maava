# paperai — 📄 🤖 AI for medical and scientific papers | olud.ai

> Generate summaries and reports from medical and scientific papers using AI to assist with research tasks (Apache-2.0, 2020). 1.8k stars on GitHub.

_Source: https://olud.ai/project/neuml-paperai.html_
...
[146](https://olud.ai/most-forked.html)
...
- [document-search](https://olud.ai/dna/document-search.html)
Apache-2.0
- [Python](https://olud.ai/language/python.html)

[View on GitHub](https://github.com/neuml/paperai)

𝕏  X / Twitter

🔗  Copy link

In plain wordsGenerate summaries and reports from medical and scientific papers using AI to assist with research tasks.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=neuml%2Fpaperai)
...
paperai has 1.8k stars on GitHub. It has been forked 146 times. paperai is written mainly in Python. It has been in active development since 2020. paperai is available under the Apache-2.0 license. Its main topics are ai, artificial-intelligence, document-search, machine-learning.
...
paperai is an open-source project. It is released under the Apache-2.0 license.

#### Is paperai free?
Yes. paperai is free and open source — you can use, modify and self-host it.

#### What license does paperai use?
paperai is available under the Apache-2.0 license.

#### What language is paperai written in?
paperai is written mainly in Python.

🏅 Maintainer of this project?

olud.ai badge — paperai
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=neuml-paperai)](https://olud.ai/project/neuml-paperai.html)`
Copy Markdown

[More badge options →](https://olud.ai/badge.html)

🧬 Related projects[🧬 View the DNA map →](https://olud.ai/dna/document-search.html)
