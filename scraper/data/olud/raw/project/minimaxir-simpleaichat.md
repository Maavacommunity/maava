# simpleaichat — Python package for easily interfacing with chat apps… | olud.ai

> Create and manage chat interactions with apps like ChatGPT using simple Python code. Python package for easily interfacing (MIT, 2023). 3.5k stars on GitHub.

_Source: https://olud.ai/project/minimaxir-simpleaichat.html_
...
[217](https://olud.ai/most-forked.html)
...
[View on GitHub](https://github.com/minimaxir/simpleaichat)

𝕏  X / Twitter

🔗  Copy link

In plain wordsCreate and manage chat interactions with apps like ChatGPT using simple Python code.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=minimaxir%2Fsimpleaichat)
...
simpleaichat has 3.5k stars on GitHub. It has been forked 217 times. simpleaichat is written mainly in Python. It has been in active development since 2023. simpleaichat is available under the MIT license. Its main topics are ai, chatgpt.
...
simpleaichat is an open-source project. It is released under the MIT license.

#### Is simpleaichat free?
Yes. simpleaichat is free and open source — you can use, modify and self-host it.

#### What license does simpleaichat use?
simpleaichat is available under the MIT license.

#### What language is simpleaichat written in?
simpleaichat is written mainly in Python.

🏅 Maintainer of this project?

olud.ai badge — simpleaichat
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=minimaxir-simpleaichat)](https://olud.ai/project/minimaxir-simpleaichat.html)`
Copy Markdown
