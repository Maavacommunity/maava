# summarize — Point at any URL/YouTube/Podcast or file. Get the gi… | olud.ai

> Summarize content from web pages, videos, and podcasts quickly using a command line tool or browser extension (MIT, 2025). 6.4k stars on GitHub.

_Source: https://olud.ai/project/steipete-summarize.html_
...
[438](https://olud.ai/most-forked.html)
...
- [summarize](https://olud.ai/projects.html?cat=summarize)
MIT
- [TypeScript](https://olud.ai/language/typescript.html)

[View on GitHub](https://github.com/steipete/summarize)

𝕏  X / Twitter

🔗  Copy link

In plain wordsSummarize content from web pages, videos, and podcasts quickly using a command line tool or browser extension.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=steipete%2Fsummarize)
...
summarize has 6.4k stars on GitHub. It has been forked 438 times. summarize is written mainly in TypeScript. It has been in active development since 2025. summarize is available under the MIT license. Its main topics are ai, cli, summarize, typescript.
...
summarize is an open-source project. It is released under the MIT license.

#### Is summarize free?
Yes. summarize is free and open source — you can use, modify and self-host it.

#### What license does summarize use?
summarize is available under the MIT license.

#### What language is summarize written in?
summarize is written mainly in TypeScript.

🏅 Maintainer of this project?

olud.ai badge — summarize
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=steipete-summarize)](https://olud.ai/project/steipete-summarize.html)`
Copy Markdown
