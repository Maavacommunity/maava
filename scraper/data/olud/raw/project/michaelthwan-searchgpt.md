# searchGPT — Grounded search engine (i.e. with source reference)… | olud.ai

> Search the web and files for information, getting answers in natural language with source references (MIT, 2023). 710 stars on GitHub.

_Source: https://olud.ai/project/michaelthwan-searchgpt.html_
...
by **michaelthwan** · GitHub

[710](https://olud.ai/most-starred.html)
...
- [grounded-api](https://olud.ai/projects.html?cat=grounded-api)
MIT
- [Python](https://olud.ai/language/python.html)

[View on GitHub](https://github.com/michaelthwan/searchGPT)

𝕏  X / Twitter

🔗  Copy link

In plain wordsSearch the web and files for information, getting answers in natural language with source references.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=michaelthwan%2FsearchGPT)
...
searchGPT has 710 stars on GitHub. It has been forked 68 times. searchGPT is written mainly in Python. It has been in active development since 2023. searchGPT is available under the MIT license. Its main topics are ai, chatgpt, grounded-api, grounded-bot.
...
searchGPT is an open-source project. It is released under the MIT license.

#### Is searchGPT free?
Yes. searchGPT is free and open source — you can use, modify and self-host it.

#### What license does searchGPT use?
searchGPT is available under the MIT license.

#### What language is searchGPT written in?
searchGPT is written mainly in Python.

🏅 Maintainer of this project?

olud.ai badge — searchGPT
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=michaelthwan-searchgpt)](https://olud.ai/project/michaelthwan-searchgpt.html)`
Copy Markdown
