# ai — 🤖 Type-safe, provider-agnostic TypeScript AI SDK for… | olud.ai

> Create AI applications with streaming chat and multimedia features using a flexible SDK. 🤖 Type-safe, provider-agnostic (MIT, 2025). 3k stars on GitHub.

_Source: https://olud.ai/project/tanstack-ai.html_
...
[313](https://olud.ai/most-forked.html)
...
- [ai-sdk](https://olud.ai/dna/ai-sdk.html)
MIT
- [TypeScript](https://olud.ai/language/typescript.html)

[View on GitHub](https://github.com/TanStack/ai)

𝕏  X / Twitter

🔗  Copy link

In plain wordsCreate AI applications with streaming chat and multimedia features using a flexible SDK.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=TanStack%2Fai)
...
ai has 3k stars on GitHub. It has been forked 313 times. ai is written mainly in TypeScript. It has been in active development since 2025. ai is available under the MIT license. Its main topics are ai, ai-agents, ai-sdk, anthropic.
...
#### Is ai open source?
ai is an open-source project. It is released under the MIT license.

#### Is ai free?
Yes. ai is free and open source — you can use, modify and self-host it.

#### What license does ai use?
ai is available under the MIT license.

#### What language is ai written in?
ai is written mainly in TypeScript.
...
`[![olud.ai](https://olud.ai/badge.php?tool=tanstack-ai)](https://olud.ai/project/tanstack-ai.html)`
Copy Markdown
