# DeepMosaics — Automatically remove the mosaics in images and video… | olud.ai

> Automatically add or remove mosaics in images and videos with a few clicks. Automatically remove the mosaics in images (GPL-3.0, 2019). 2.6k stars on GitHub.

_Source: https://olud.ai/project/hypox64-deepmosaics.html_
...
[487](https://olud.ai/most-forked.html)
...
- [mosaic](https://olud.ai/projects.html?cat=mosaic)
GPL-3.0
- [Python](https://olud.ai/language/python.html)

[View on GitHub](https://github.com/HypoX64/DeepMosaics)

𝕏  X / Twitter

🔗  Copy link

In plain wordsAutomatically add or remove mosaics in images and videos with a few clicks.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=HypoX64%2FDeepMosaics)
...
DeepMosaics has 2.6k stars on GitHub. It has been forked 487 times. DeepMosaics is written mainly in Python. It has been in active development since 2019. DeepMosaics is available under the GPL-3.0 license. Its main topics are computer-vision, deep-learning, mosaic, pytorch.
...
DeepMosaics is an open-source project. It is released under the GPL-3.0 license.

#### Is DeepMosaics free?
Yes. DeepMosaics is free and open source — you can use, modify and self-host it. Its GPL-3.0 license is copyleft: if you distribute a modified version, it must remain under the same license.

#### What license does DeepMosaics use?
DeepMosaics is available under the GPL-3.0 license.

#### What language is DeepMosaics written in?
DeepMosaics is written mainly in Python.

🏅 Maintainer of this project?

olud.ai badge — DeepMosaics
Add this live badge to your README — your GitHub stars and directory rank, refreshed daily.

`[![olud.ai](https://olud.ai/badge.php?tool=hypox64-deepmosaics)](https://olud.ai/project/hypox64-deepmosaics.html)`
Copy Markdown
