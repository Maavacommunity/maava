# puck — The visual editor for React. | olud.ai

> Build custom drag-and-drop interfaces for your React applications using a visual editor (MIT, 2023). 13k stars on GitHub.

_Source: https://olud.ai/project/puckeditor-puck.html_
...
by **puckeditor** · GitHub

[13k](https://olud.ai/most-starred.html)

Stars

[934](https://olud.ai/most-forked.html)
...
Language
- [ai](https://olud.ai/projects.html?cat=ai)
- [builder](https://olud.ai/projects.html?cat=builder)
- [drag-and-drop](https://olud.ai/projects.html?cat=drag-and-drop)
MIT
- [TypeScript](https://olud.ai/language/typescript.html)

[View on GitHub](https://github.com/puckeditor/puck)

𝕏  X / Twitter

🔗  Copy link

In plain wordsBuild custom drag-and-drop interfaces for your React applications using a visual editor.
...
Excerpts from the project README on [GitHub](https://github.com/puckeditor/puck). Copyright and licensing remain with the respective authors.

You maintain this project?

Claim its page: indexed whatever its rank, translated into six languages, and enriched with what you write yourself.

[Claim this page →](https://olud.ai/claim.html?repo=puckeditor%2Fpuck)
...
puck has 13k stars on GitHub. It has been forked 934 times. puck is written mainly in TypeScript. It has been in active development since 2023. puck is available under the MIT license. Its main topics are ai, builder, drag-and-drop, draganddrop.
...
#### Is puck open source?
puck is an open-source project. It is released under the MIT license.

#### Is puck free?
Yes. puck is free and open source — you can use, modify and self-host it.

#### What license does puck use?
puck is available under the MIT license.

#### What language is puck written in?
puck is written mainly in TypeScript.
...
`[![olud.ai](https://olud.ai/badge.php?tool=puckeditor-puck)](https://olud.ai/project/puckeditor-puck.html)`
Copy Markdown
