# Gemini 3.5 Flash — Pricing, Context Window & Open-Source Alternatives

> Gemini 3.5 Flash (Google): live API pricing, context window and the best open-source alternatives, tracked daily by olud.ai.

_Source: https://olud.ai/model/gemini-3-5-flash.html_

---

[Home](https://olud.ai/) › [Models](https://olud.ai/model/) › Gemini 3.5 Flash
[Google · all models ›](https://olud.ai/maker/google.html)

## **G**Gemini 3.5 FlashAPI
...
- **$3.38** per 1M tokens, assuming 3 input for 1 output the convention used by Artificial Analysis
- cheaper than 38% of the 192 commercial models tracked here**
- 29 of 34 Google models tracked here, from cheapest
...
Cheaper and better on this index: [Grok 4.6](https://olud.ai/model/grok-4-6.html) · [GPT-5.6 Sol (batch)](https://olud.ai/model/gpt-5-6-sol-batch.html) · [GLM 5.3](https://olud.ai/model/glm-5-3.html) and 16 more
